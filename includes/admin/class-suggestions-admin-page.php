    ...
    public function render_briefs_page(): void {
        ...
        if ($focus_brief_id > 0) {
            ...
            if ($focus_brief_error !== '') {
                ...
                echo '<p><strong>Cluster:</strong> ' . esc_html((string) ($focus_brief_row['cluster_key'] ?? '')) . '</p>';
                ...
                echo '<p><strong>Recommended article type:</strong> ' . esc_html((string) ($focus_brief_payload['recommended_article_type'] ?? '')) . '</p>';
