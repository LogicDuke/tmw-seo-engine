...
class Admin {
    ...
    public static function menu(): void {
        ...
        add_submenu_page(self::MENU_SLUG, __('Staging Ops', 'tmwseo'), __('Staging Ops', 'tmwseo'), 'manage_options', 'tmwseo-staging-ops', ['\\TMWSEO\\Engine\\Admin\\StagingOperationsPage', 'render_page']);
    ...
    public static function run_worker_now(): void {
        AdminFormHandlers::run_worker_now();
    }

    public static function handle_reset_discovery_data(): void {
        AdminFormHandlers::handle_reset_discovery_data();
    }
    ...
    public static function legacy_save_settings_redirect(): void {
        AdminFormHandlers::legacy_save_settings_redirect();
    }
    ...
    public static function run_keyword_cycle_now(): void {
        AdminFormHandlers::run_keyword_cycle_now();
    }
    ...
    /**
     * Handler for admin_post_tmwseo_force_recheck_keyword_metrics.
     * Bypasses the 14-day metrics_updated_at skip window and purges stale transients
     * so rows stamped by earlier broken-parser or no-data runs are re-checked.
    ...
    public static function run_pagespeed_cycle_now(): void {
        AdminFormHandlers::run_pagespeed_cycle_now();
    }


    public static function enable_indexing_now(): void {
        AdminFormHandlers::enable_indexing_now();
    }
    ...
    public static function handle_optimize_post_now(): void {
        AdminFormHandlers::handle_optimize_post_now();
    }
