...
class ModelOpportunityAdminPage {
    ...
    public static function render_page(): void {
        ...
        echo '<p><input type="file" name="opp_file" accept=".csv,.txt,text/csv,text/plain" required /></p>';
    ...
    public static function handle_import(): void {
        ...
        $wpdb->insert($table, [
            'import_mode' => $mode,
            'source' => 'kws_everywhere',
            'filename' => sanitize_file_name((string)($_FILES['opp_file']['name'] ?? '')),
