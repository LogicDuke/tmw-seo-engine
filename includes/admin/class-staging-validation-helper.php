...
class Staging_Validation_Helper {
    ...
    private static function render_schema_diagnostics(): void {
        ...
        $cluster_schema_version = (string) get_option('tmw_cluster_schema_version', 'not_set');
    ...
    private static function render_validation_export(): void {
        ...
        $lines[] = 'Cluster DB version: ' . (string) get_option('tmw_cluster_schema_version', 'not_set');
