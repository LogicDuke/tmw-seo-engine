...
class Loader {
    ...
    private static function load_import(): void {
        ...
        tmwseo_safe_require( $p . 'class-livejasmin-remote-profile-fetch-service.php' );
    ...
    private static function load_content(): void {
        ...
        tmwseo_safe_require( $p . 'category-pipeline/class-category-density-policy.php' ); // v5.9.11
    ...
    private static function load_admin(): void {
        ...
        tmwseo_safe_require( $p . 'class-keyword-pool-target-provider.php' );
        tmwseo_safe_require( $p . 'class-keyword-pool-review-admin-card.php' );
