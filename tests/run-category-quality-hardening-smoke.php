...
$impossible = $fail_res;
if ($impossible['ok']) {
    // Force certain failure: fingerprint the finalized draft of EVERY salt so
    // all retries collide with their own production-equivalent shadow.
    $shadows = tmwseo_category_collision_shadows($dup_ctx, []);
