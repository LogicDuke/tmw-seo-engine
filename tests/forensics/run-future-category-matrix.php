...
$pipeline_dir = dirname(__DIR__, 2) . '/includes/content/category-pipeline/';
foreach ([
    'class-category-context-builder','class-category-intent-classifier','class-category-keyword-planner','class-category-chip-feasibility', 'class-category-semantic-profile', 'class-category-semantic-sections', 'class-category-interchangeability-guard',
