 ...
 * Description: Intelligence Core v5.8.22-templatepool-rankmath-copy-balance — TemplatePool is now the primary content builder for manual model Generate on sufficient-data pages. Replaces legacy paragraph bags with TemplatePool section bodies while preserving all CTA/affiliate HTML blocks, ModelResearchEvidence, ModelCopyCleanup, sparse fallback, and all non-model-generate paths unchanged.
 * Version: 5.8.22-templatepool-rankmath-copy-balance
...
defined('TMWSEO_ENGINE_VERSION') || define('TMWSEO_ENGINE_VERSION', '5.8.22-templatepool-rankmath-copy-balance');
