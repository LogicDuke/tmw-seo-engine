 ...
 * Description: Intelligence Core v5.9.6-category-keyword-density-root-family-v1.0.0 - Category pages: Rank Math extras remain saved while root-family body-use planning, dump repair, density-safe copy, and extended verification prevent keyword stuffing.
 * Version: 5.9.6-category-keyword-density-root-family-v1.0.0
...
defined('TMWSEO_ENGINE_VERSION') || define('TMWSEO_ENGINE_VERSION', '5.9.6-category-keyword-density-root-family-v1.0.0');
