 ...
 * Description: Intelligence Core v4.6.1 — Stabilized: kill switches, hardened bootstrap, configurable queue cap, DataForSEO SERP model research. Includes GSC, AI Router, SERP, Ranking Probability, JSON-LD Schema, Orphan Detector, CSV Export, Competitor Monitor.
 * Version: 4.6.1
...
defined('TMWSEO_ENGINE_VERSION') || define('TMWSEO_ENGINE_VERSION', '4.6.1');
